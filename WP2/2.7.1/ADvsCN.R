...
# In this scipt netDx is trained on 614 samples (half AD, half CN).
...
pheno<-read.table("/home/cmengoni/INC_BOTH_AD_CL/clinical_encoded.txt",header = 1)
...
pheno_2<-read.table('/home/cmengoni/DiGAS/pheno/test_missingness/original.txt')
